...
LOG_PATH=$SCRIPTS_PATH/configure_05-ssl-letsencrypt-gw2-reuse-old.log
...
chmod +x $SCRIPTS_PATH/getLetsEncryptCert_gw2-reuse-old.sh
sudo bash $SCRIPTS_PATH/getLetsEncryptCert_gw2-reuse-old.sh
echo ""
echo "" >> $LOG_PATH
